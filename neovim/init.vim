...
Plug 'https://github.com/ludovicchabant/vim-gutentags'      " Tag management
Plug 'https://github.com/mkitt/tabline.vim'                 " Shows file state on the tab line
...
let g:coc_global_extensions = ['coc-tslint-plugin', 'coc-tsserver', 'coc-java', 'coc-css', 'coc-html', 'coc-json', 'coc-prettier']  " list of CoC extensions needed
" let g:coc_global_extensions = ['coc-tslint-plugin', 'coc-tsserver', 'coc-java', 'coc-css', 'coc-html', 'coc-json', 'coc-prettier', 'coc-go']  " list of CoC extensions needed
...
" these plugins will add highlighting for Go language
...
" Key mappings to make life easier
